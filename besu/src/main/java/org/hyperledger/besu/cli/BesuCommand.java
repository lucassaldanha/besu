...
import org.hyperledger.besu.pki.config.PkiBlockCreationConfiguration;
...
public class BesuCommand implements DefaultCommandValues, Runnable {
  ...
  private Optional<PkiBlockCreationConfiguration> pkiBlockCreationConfig;
  ...
  private void configure() throws Exception {
    ...
    pkiBlockCreationConfig = pkiBlockCreationOptions.asDomainConfig(commandLine);
    pkiBlockCreationConfig.ifPresent(KeyStoreSupplier::load);
  }
